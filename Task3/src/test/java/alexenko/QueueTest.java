...
public class QueueTest {
    ...
    public void testEnqueueOneObjWhenQueueFull(){
        Queue queue = new Queue(TEST_SIZE_QUEUE);
        ...
        Assertions.assertThrowsExactly(RuntimeException.class,()->{queue.enqueue(6);});
    }

    @Test
    @DisplayName("Удаление элемента из не пустой очереди")
    public void testDequeueOneObj(){
        Queue queue = new Queue(TEST_SIZE_QUEUE);
    ...
    public void testDequeueOneObjWhenQueueEmpty(){
        Queue queue = new Queue(TEST_SIZE_QUEUE);
    ...
    public void testGetTopObjAfterDequeueObjFromQueue(){
        Queue queue = new Queue(TEST_SIZE_QUEUE);
    ...
    public void testGetAllObjFromQueue(){
        Queue queue = new Queue(TEST_SIZE_QUEUE);
    ...
    public void testGetAllObjWhenQueueIsEmpty(){
        Queue queue = new Queue(TEST_SIZE_QUEUE);
