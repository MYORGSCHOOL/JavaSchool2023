...
public class StackTest {
    ...
    public void testPushObjWhenStackNotFull() {
    ...
    public void testPopObjWhenStackNotEmpty() {
        Stack stack = new Stack(TEST_SIZE_STACK);
    ...
    @Test
    @DisplayName("Удаление верхнего элемента из не пустого стека")
    public void testPopObjWhenStackIsEmpty() {
        Stack stack = new Stack(TEST_SIZE_STACK);
    ...
    public void testGetTopObjWhenStackNotEmpty(){
        Stack stack = new Stack(TEST_SIZE_STACK);
    ...
    public void testGetTopObjWhenStackIsEmpty(){
        Stack stack = new Stack(TEST_SIZE_STACK);
    ...
    public void testGetAllObjWhenStackIsEmpty(){
        Stack stack = new Stack(TEST_SIZE_STACK);
    ...
    public void testGetAllObjWhenStackNotEmpty(){
        Stack stack = new Stack(TEST_SIZE_STACK);
